...
/**
 * Excepción básica usada en la aplicación «Red IPv4». Alerta generalmente de
 * datos incorrectos no válidos.
 * 
...
public class IPv4Exception extends Exception {
	 ...
	 */
	public IPv4Exception(String mensaje) {
		super(mensaje);
	}
	 ...
	 */
	public IPv4Exception(Throwable causa) {
		super(causa);
	}
	 ...
	 */
	public IPv4Exception(String mensaje, Throwable causa) {
		super(mensaje, causa);
	}
	 ...
	 */
	public IPv4Exception(String mensaje, Throwable causa, boolean habilitarSupresión, boolean trazaPilaEditable) {
